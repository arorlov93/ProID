...
/* ═══ АКТ ОСВИДЕТЕЛЬСТВОВАНИЯ СКРЫТЫХ РАБОТ ════════════════════════════════
   Форма приложения 3 к РД-11-02-2006: участники, предъявленные работы,
...
/* ═══ ОБЩИЙ ЖУРНАЛ РАБОТ ═══════════════════════════════════════════════════
   Раздел 3 по РД-11-05-2007: даты, содержание работ, отметка о контроле. */
...
export function zhurnal() {
  ...
  s.push(txt(72, 100, 'Объект: корпус 2 · форма по РД-11-05-2007', 'd-txt-xs'));
